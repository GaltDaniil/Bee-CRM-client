...
type FusePageSimpleProps = SystemStyleObject<Theme> & {
    ...
    rightOrderSidebarContent?: ReactNode;
    ...
    rightOrderSidebarOpen?: boolean;
    leftSidebarWidth?: number;
    rightSidebarWidth?: number;
    rightSidebarOnClose?: () => void;
    rightOrderSidebarOnClose?: () => void;
...
>((props, ref) => {
    ...
    const rightOrderSidebarRef = useRef<{ toggleSidebar: (T: boolean) => void }>(null);
    ...
    useImperativeHandle(ref, () => ({
        ...
        toggleRightOrderSidebar: (val: boolean) => {
            rightOrderSidebarRef.current.toggleSidebar(val);
        },
    }));
                    ...
                    <div className="FusePageSimple-wrapper">
                        ...
                        {rightOrderSidebarContent && (
                            <FusePageSimpleSidebar
                                position="right"
                                variant={rightSidebarVariant || 'permanent'}
                                ref={rightOrderSidebarRef}
                                open={rightOrderSidebarOpen}
                                onClose={rightOrderSidebarOnClose}
                            >
                                {rightOrderSidebarContent}
                            </FusePageSimpleSidebar>
                        )}
