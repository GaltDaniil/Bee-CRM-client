...
type FormType = {
    list_title: ListType['list_title'];
};
/**
 * Form Validation Schema
 */
const schema = yup.object().shape({
    list_title: yup.string().required('You must enter a title'),
});
...
function BoardListHeader(props: BoardListHeaderProps) {
    ...
    }, [formOpen, reset, list.list_title]);
    ...
    function onSubmit(newData: FormType) {
        dispatch(updateList({ id: list.list_id, newData }));
        handleCloseForm();
    }
    ...
    return (
        <div {...handleProps}>
            <div
                className={clsx('flex items-center justify-between h-48 sm:h-56 px-12', className)}
            >
                ...
                <div className="flex items-center">
                    ...
                    >
                        <MenuItem
                            onClick={() => {
                                dispatch(removeList(list.list_id));
                            }}
                        >
