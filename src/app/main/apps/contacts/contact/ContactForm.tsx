...
const schema = yup.object().shape({
    contact_id: yup.string().required('ID is required'),
    contact_avatar: yup.string().required('Avatar is required'),
...
function ContactForm() {
    ...
    function handleRemoveContact() {
        ...
        dispatch(removeContact(contact.contact_id)).then(() => {
                ...
                <Controller
                    ...
                    render={({ field: { onChange, value } }) => (
                        <Autocomplete
                            ...
                            value={
                                value
                                    ? (value.map((id) => _.find(tags, { id })) as TagsType)
                                    : ([] as TagsType)
                            }
