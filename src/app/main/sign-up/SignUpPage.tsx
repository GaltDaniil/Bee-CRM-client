...
const schema = yup.object().shape({
    user_name: yup.string().required('You must enter display name'),
    user_email: yup
        .string()
...
function SignUpPage() {
    ...
    function onSubmit({ user_name, user_password, user_email }: typeof defaultValues) {
        jwtService
            .createUser({
                user_name,
                user_password,
            ...
            .catch(
                (
                    _errors: {
                        type: 'user_email' | 'user_password' | `root.${string}` | 'root';
                        message: string;
                    }[],
                ) => {
